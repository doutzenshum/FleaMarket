...
<div class="main">
	<div class="content" style="border: solid #CCC 1px;">
		<div class="content_top1" >
			 <h4>
				个人闲置 : <a href="showSpeciesGoods_goods.action?speciesid=0">全部  </a><span class="pipe-gt">&gt;</span>
							...
							<ul class="J_HiddenAreaContent sub-category-list clearfix">
								...
								<s:iterator var="species" value="#session.allSpecies" >
									<s:if test="#species.parentid==#session.allGoods.speciesid">
										...
										href="showSpeciesGoods_goods.action?speciesid=<s:property value="#species.speciesid"/>"> <em
...
<!-- 显示所有的商品-->
<s:iterator var="goods" value="#session.allGoods.list" status="vs">
	<s:if test="#vs.count%4==1">
		<div class="section group">
	</s:if>
		<div class="grid_1_of_4 images_1_of_4">
			<a href="showgoodsid_goods.action?goodsid=<s:property value="#goods.goodsid"/>"> <img
				src="./images/goods/<s:property value="#goods.goodsimg"/>" alt="" /></a>
			<h2><s:property value="#goods.goodstitle"/></h2>
			<div class="price-details">
				<div class="price-number">
					<p>
						<span class="rupees">￥<s:property value="#goods.goodsprice"/></span>
					</p>
				</div>
				<div class="add-cart">
					<h4>
						<a href="showgoodsid_goods.action?goodsid=<s:property value="#goods.goodsid"/>">瞅瞅</a>
					</h4>
				</div>
				<div class="clear">
					<span><s:property value="#goods.goodsneworold"/></span>
				</div>
			</div>
		</div>
			...
			<div class="page clearfix">
				<div id="J_bottomPage" class="p-wrap">
					<span class="p-num"> <a class="pn-prev"
						href="showSpeciesGoods_goods.action?currentpage=<s:property value="#session.allGoods.prepage"/>&speciesid=<s:property value="#session.allGoods.speciesid"/>">
							<i><</i><em>上一页</em>
					</a> <a class=" curr" id="select_page_my"><s:property value="#session.allGoods.currentpage"/></a> <a class="pn-next"
						href="showSpeciesGoods_goods.action?currentpage=<s:property value="#session.allGoods.nextpage"/>&speciesid=<s:property value="#session.allGoods.speciesid"/>">
							下一页<i>></i>
					</a>
...
<script type="text/javascript">
		function page_jump(speciesid){
			...
			location.href="showSpeciesGoods_goods.action?currentpage="+jump+"&speciesid="+speciesid;
		}
</script>
