...
<script type="text/javascript">
	...
	$(function() {
		datagrid = $("#replydg").edatagrid({
			url : "BackComment_listadvice.action",//查询时加载的URL
            destroyUrl: "BackComment_deleteadvice.action",
			idField : "adviceid", ///标识、会记录我们选中项的id、不一定是id、通常使用主键
			...
			sortName : 'adviceid',//设置默认排序时的 字段（必须是field中的一个字段）
