...
<script type="text/javascript">
	...
	$(function() {
		datagrid = $("#admindg").edatagrid({
            url : "BackAdmin_list.action",//查询时加载的URL
			saveUrl: "BackAdmin_add.action",//addadmin
            updateUrl: "BackAdmin_update.action",//updateadmin
            destroyUrl: "BackAdmin_delete.action",//deleteadmin
