...
<script type="text/javascript">
	...
	$(function() {
		datagrid = $("#gooddg").edatagrid({
			url : "BackGoods_listgoods.action",//查询时加载的URL
			destroyUrl: "BackGoods_deletegoods.action",
			updateUrl: "BackGoods_updategoods.action",//TODO 更新的操作本来也没有实现 
