...
<div class="main" id="toshowswap">
	<div class="content" style="border: solid #CCC 1px;">
		<div class="content_top1" >
			 <h4>
				换物专区 : <a href="swap_showsmallspeciesSwap.action?speciesid=0">全部  </a><span class="pipe-gt">&gt;</span>
		...
		<div class="grid_1_of_4 images_1_of_4">
			...
			<div class="price-details">
				<div class="price-number">
					<p>
						<span class="rupees"><font size="-1" color="#cd1f25">目标换物：</font><s:property value="#goods.swapaim"/></span>
					</p>
				</div>
				<div class="add-cart">
					<h4>
						<a href="swap_findOneSwap.action?swapid=<s:property value="#goods.swapid"/>">换</a>
					</h4>
				</div>
				<div class="clear">
