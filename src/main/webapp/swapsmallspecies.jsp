...
<!-- 显示所有的商品-->
<sx:div href="swap_showsmallspeciesSwap.action?speciesid=0&currentpage=1" id="toshowswap_main"></sx:div>
...
<script type="text/javascript">
		function page_jump(speciesid){
			...
			location.href="swap_showsmallspeciesSwap.action?currentpage="+jump+"&speciesid="+speciesid;
		}
</script>
