...
<html>
	<head>
		...
		<link rel="stylesheet"
			href="${basePath }easyui/themes/bootstrap/easyui.css" type="text/css"
			media="screen" />
			...
			<form id="index_loginForm" method="post" >
				<table style="padding: 10px; margin: 10px">
					...
					<tr>
						...
						<td>
							<input type="password" id="adminpwd" name="adminpass"
								class="easyui-validatebox" data-options="required:true" />
						</td>
					</tr>
					<tr>
	...
	$(function() {
		...
		$("#index_loginForm").form(   {
			...
			success: function(data){
				...
				if(  obj.code==1 ){
					location.href="${basePath}nanhua/backmain.jsp";
				}else{
					$.messager.show({
						title:'login failed',
						msg:obj.msg,
